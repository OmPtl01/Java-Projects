...
public class Line {
	...
	{ 
		double a1= end2.getX()-end1.getX();
		double a2=end2.getY()-end1.getY();
	...
	public Point midpoint()
	{
		...
		double m2=(end2.getY()+end2.getY())/(2);
	...
	{
	double c1= Math.abs(this.distance()-otherLine.distance());
	return Math.abs(c1) <= .001;
